...
| 20260427-190000-fn-length-large-builders | open (Slice #193 closed 4/8 small overshoots; user scoped large UI builders to follow-up — see suggestion file) | medium | 4 UI builder functions still exceed 15-statement linter budget (AC-PROJ-20) — `BuildDashboard` 34, `BuildErrorLog` 27, `ruleRow` 17, `accountRow` 16 |
