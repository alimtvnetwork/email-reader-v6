...
| 04 | [App Error Log View](./04-app-error-log-view/00-overview.md) | Desktop-app diagnostics surface: errtrace ring buffer, sidebar badge, first-error toast, JSONL persistence + rotation, `email-read errors tail` CLI | 1 |
